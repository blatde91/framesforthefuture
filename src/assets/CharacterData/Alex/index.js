const stage = require('./alexStage.jpg');
const idle = require('./alexStance.gif');
const data = require('./Alex.json');
...
const MK = require('./GIFs/AlexMK.gif');
const HK = require('./GIFs/AlexHK.gif');
