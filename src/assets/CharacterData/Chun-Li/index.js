const stage = require('./chunStage.png');
const idle = require('./chunStance.gif');
const data = require('./Chun.json');
...
const MK = require('./GIFs/ChunMK.gif');
const HK = require('./GIFs/ChunHK.gif');
